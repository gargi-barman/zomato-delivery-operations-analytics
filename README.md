...
- **Festival days see a 94.42% breach rate** vs. 24.88% on non festival days which is nearly a 4x spike, despite festival orders being only ~2% of total volume (896 of 45,584 orders) — *Festival Table*
- **Risk Level directly predicts breach likelihood:** Low risk conditions breach 12.97% of the time; High risk conditions breach 37.07% — a clear, monotonic relationship validating the weather/traffic scoring model — *Risk Level Breach % table*
...
- Column charts for Breach % by Vehicle, Breach % by City, and Breach % (Festivals).
